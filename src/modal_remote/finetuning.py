...
import src.core.finetuning as finetuning
...
def download_models(config):
    import torch
    from diffusers import DiffusionPipeline # type: ignore (relic from the version of diffusers used in the modal image)
